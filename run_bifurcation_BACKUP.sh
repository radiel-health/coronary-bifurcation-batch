...
MESHES=(
    "bifurcation_angle30_750.msh"
    "bifurcation_angle45_750.msh"
    "bifurcation_angle60_750.msh"
)
...
echo "Re Range:  $RE_START - $RE_END (step $RE_STEP)"
...
# Build array of Reynolds numbers
RES=()
for (( re=RE_START; re<=RE_END; re+=RE_STEP )); do
    RES+=($re)
done
...
for MESH in "${MESHES[@]}"; do
    ...
    for Re in "${RES[@]}"; do
        ...
        # Calculate velocity
        VELOCITY=$(python3 -c "print(${Re} * ${NU} / ${DIAMETER})")
